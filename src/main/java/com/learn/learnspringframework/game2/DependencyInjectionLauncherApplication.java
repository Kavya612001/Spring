...
class BusinessClass {
    ...
    //@Autowired - annotation is not necessary for constructor
...
public class DependencyInjectionLauncherApplication {
    ...
    public static void main(String[] args) {
        ...
        AnnotationConfigApplicationContext context = new AnnotationConfigApplicationContext(DependencyInjectionLauncherApplication.class);
